...
<div class="input-group">
	<select class="form-control" id="fileList" name="fileList">

	</select>
	<span class="input-group-addon" style="padding:0px 0px; float : left; width:auto !important; border-width:0px !important;"><button id="file_down" class="btnTypeS1" style="width:100%; height:100%;">파일다운</button></span>
</div>
<script>
$(document).ready(function(){
	$("#file_down").on("click",function(){
		var attach_no = $("#fileList option:selected").data("attach");
		var ser_no = $("#fileList option:selected").data("ser");
