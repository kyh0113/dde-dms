...
<body data-ng-app="app">
	...
	<script>
		...
		$(document).ready(function() {
			...
			// EXEC_RFC : "FI"
			var param = {
				listQuery : "yp_zwc_ent2.select_zwc_ent2_data_search_worker_popup_list", //list가져오는 마이바티스 쿼리 아이디
				cntQuery : "yp_zwc_ent2.select_zwc_ent2_data_search_worker_popup_list_cnt" //list cnt 가져오는 마이바티스 쿼리 아이디
			};
	...
	function fn_worker_popup_save(){
		...
		$("#SUBC_CODE", opener.document).val(selectedRows[0].SUBC_CODE);
		$("#SUBC_NAME", opener.document).val(selectedRows[0].SUBC_NAME);
