...
<div id="popup">
	...
	<div class="pop_content">
		...
		<input type="hidden" name="WR_CODES" id="WR_CODES" value="${req_data.WR_CODES}" />
		<input type="hidden" name="WR_TYPE" id="WR_TYPE" value="A" />
		<input type="hidden" name="WR_FINAL" id="WR_FINAL" value="Y" />
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
					...
					<td colspan="3">
						<input type="text" id="WR_NAME" name="WR_NAME" style="width:950px;" value="전산작업 처리서 " placeholder="전산작업  처리서 "/>
					</td>
				</tr>
				<tr>
					<th>작성부서</th>
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
					<th>작업자<span class="require">*</span></th>
					<td>
						<input type="text" id="WR_WORK" name="WR_WORK" value="${req_data.WR_WORK}"/>
					</td>
					<th>작업기간(시작/종료)<span class="require">*</span></th>
					<td>
						<input type="text" class="calendar dtp" name="WR_WSDATE" id="WR_WSDATE" value="${req_data.WR_WSDATE}" readonly/> 
						~ 
						<input type="text" class="calendar dtp" name="WR_WEDATE" id="WR_WEDATE" value="${req_data.WR_WEDATE}" readonly/>
					</td>		
				</tr>
				
				<tr>		
					<th>SYSTEM<span class="require">*</span></th>
					<td>
					...
					<th>작업종류<span class="require">*</span></th>
					<td>
				...
				<tr>
					<th>테스트(시작/종료)<span class="require">*</span></th>
					<td>
						<input type="text" class="calendar dtp" name="WR_TSDATE" id="WR_TSDATE" value="${req_data.WR_TSDATE}" readonly/> 
						~ 
						<input type="text" class="calendar dtp" name="WR_TEDATE" id="WR_TEDATE" value="${req_data.WR_TEDATE}" readonly/>
					</td>
					<th>완료예정일<span class="require">*</span></th>
					<td>
						<input type="text" class="calendar dtp" name="WR_RE_DATE" id="WR_RE_DATE" value="${req_data.WR_RE_DATE}" readonly/>
					</td>
				</tr>
				
				<tr>
					<th colspan="6">작업내역<span class="require">*</span></th>
				</tr>
				<tr>
					<td colspan="6">
						<textarea id="WR_WORKD" name="WR_WORKD" style="width:1070px; height:200px;">${req_data.WR_WORKD}</textarea>
					</td>
				</tr>
				
				<tr>
					<th colspan="6">테스트내역<span class="require">*</span></th>
				</tr>
				<tr>
					<td colspan="6">
						<textarea id="WR_TESTD" name="WR_TESTD" style="width:1070px; height:100px;">${req_data.WR_TESTD}</textarea>
					</td>
				</tr>
				<tr>
				<th>
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
				<th>요청부서<span class="require">*</span></th>
				<td>
					<input type="text" class="wid200" id="WR_CALL_DEPT" name="WR_CALL_DEPT" value="${req_data.WR_CALL_DEPT}"/>
				</td>
				<th>요청자<span class="require">*</span></th>
				<td colspan ="3">
					<input type="text" class="wid200" id="WR_CALL_EMP" name="WR_CALL_EMP" value="${req_data.WR_CALL_EMP}"/>
				</td>
				
			</tr>
			
			<tr>
				<th>최종검수부서<span class="require">*</span></th>
				<td>
					<input type="text" class="wid200" id="WR_CK_DEPT" name="WR_CK_DEPT" value="${req_data.WR_CALL_DEPT}"/>
				</td>
				<th>최종검수자<span class="require">*</span></th>
				<td>
					<input type="text" class="wid200" id="WR_CK_EMP" name="WR_CK_EMP" value="${req_data.WR_CALL_EMP}"/>
				</td>	
				
			</tr>
			<tr>
			<th>테스트일자<span class="require">*</span></th>
				<td colspan="4">
			...
			<tr>
				<td colspan="6">
					<textarea id="WR_CK_TESTD" name="WR_CK_TESTD" style="width:1070px; height:100px;"></textarea>
				</td>
			</tr>
