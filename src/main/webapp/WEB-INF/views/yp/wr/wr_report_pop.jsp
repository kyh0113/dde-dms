...
<div id="popup">
	...
	<div class="pop_content">
		...
		<input type="hidden" name="WR_TYPE" id="WR_TYPE" value="D" />
		<input type="hidden" name="WR_REPORT" id="WR_REPORT" value="Y" />
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
					...
					<td colspan="3">
						<input type="text" id="WR_NAME" name="WR_NAME" style="width:980px;" value="전산작업 보고서 "  placeholder="전산작업  보고서 " maxlength="70"/>
					</td>
				</tr>
				<tr>
					<th>작성부서</th>
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" id="WR_CALL_DEPT" name="WR_CALL_DEPT" value="${req_data.WR_CALL_DEPT}"/>
					</td>
					<th>요청자<span class="require">*</span></th>
					<td>
						<input type="text"  id="WR_CALL_EMP" name="WR_CALL_EMP" value="${req_data.WR_CALL_EMP}"/>
					</td>
				</tr>
				
				<tr>
					<th>요청일<span class="require">*</span></th>
					<td colspan="3">
						<input type="text" class="calendar dtp" name="WR_CK_TSDATE" id="WR_CK_TSDATE" value="${req_data.WR_DAY}" readonly/>
					</td>
				</tr>
				<tr>
					<th colspan="6">요청사항<span class="require">*</span></th>
				</tr>
				<tr>
					<td colspan="6">
						<textarea id="WR_CK_TESTD" name="WR_CK_TESTD"  style="width:1070px; height:200px;">${req_data.WR_WORKD}</textarea>
					</td>
				</tr>
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" id="WR_WORK" name="WR_WORK" value=""/>
					</td>
					<th>작업기간(시작/종료)<span class="require">*</span></th>
					<td>
						<input type="text" class="calendar dtp" name="WR_WSDATE" id="WR_WSDATE" value="${date}" readonly/> 
						~ 
						<input type="text" class="calendar dtp" name="WR_WEDATE" id="WR_WEDATE" value="" readonly/>
					</td>		
				</tr>
				...
				<tr>
					<th>테스트(시작/종료)</th>
					<td>
						<input type="text" class="calendar dtp" name="WR_TSDATE" id="WR_TSDATE" value="${date}" readonly/> 
						~ 
						<input type="text" class="calendar dtp" name="WR_TEDATE" id="WR_TEDATE" value="" readonly/>
					</td>
					<th>완료예정일</th>
					<td>
						<input type="text" class="calendar dtp" name="WR_RE_DATE" id="WR_RE_DATE" value="${date}" readonly/>
					</td>
				</tr>
				...
				<tr>
					<td colspan="6">
						<textarea id="WR_WORKD" name="WR_WORKD" style="width:1070px; height:200px;"></textarea>
					</td>
				</tr>
				...
				<tr>
					<td colspan="6">
						<textarea id="WR_TESTD" name="WR_TESTD" style="width:1070px; height:100px;"></textarea>
					</td>
				</tr>
