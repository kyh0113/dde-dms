...
<body>
		...
		<div class="tbl_box" style="background: none;">
			<table border="1" class="table">
				...
				<tr style="background-color: white;">
					<td class="center vertical-center" colspan="13">데이터가 없습니다.</td>
				</tr>
			</table>
		</div>
	</section>
	<script type="text/javascript">
		...
		$(document).ready(function() {
			var param = {
				EXEC_RFC : "N", // RFC 여부
				cntQuery : "yp_zcs_ipt2.select_construction_monthly_rpt1_cnt",
				listQuery : "yp_zcs_ipt2.select_construction_monthly_rpt1"
			};
			...
			$("#search_btn").on("click", function() {
				...
				$.ajax({
					url : "/yp/zcs/ipt2/select_zcs_ipt2_month_rpt1",
					type : "POST",
					cache : false,
					async : true,
					dataType : "json",
					...
					success : function(data) {
						...
						if (result1.length === 0) {
							innerHtml = '<tr><td class="center vertical-center" colspan="13">데이터가 없습니다.</td></tr>';
						...
						if (result2 === null) {
							...
							innerHtml += '	<td class="center vertical-center" colspan="9"><div style="padding: 4px 3px;">출퇴근합계</div></td>';
							...
							innerHtml += '</tr>';
							innerHtml += '<tr class="data-commute">';
							innerHtml += '	<td class="center vertical-center" colspan="11"><div style="padding: 4px 3px;">차이( 공수 - 출퇴근 )</div></td>';
				...
				swal({
					...
					if(result){
						...
						if (delete_datas.length > 0) {
							...
							var header = $("meta[name='_csrf_header']").attr("content");
							$.ajax({
								url : "/yp/zcs/ipt2/delete_zcs_ipt2_month_rpt1",
								type : "POST",
								cache : false,
								async : false,
								dataType : "json",
				...
				if (fnValidation()) {
					swal({
						...
						if(result){
							...
							var header = $("meta[name='_csrf_header']").attr("content");
							$.ajax({
								url : "/yp/zcs/ipt2/merge_zcs_ipt2_month_rpt1",
								type : "POST",
								cache : false,
								async : false,
								dataType : "json",
