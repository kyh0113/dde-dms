...
<title>정광 심판판정 결과 등록 [현재는 사용하지 않음]</title>
</head>
<body>
	...
	<script>
		...
		$(document).ready(function() {
			...
			// EXEC_RFC : "FI"
			var param = {
				listQuery : "yp_zpp.zpp_ore_umpire_result_list", //list가져오는 마이바티스 쿼리 아이디
				cntQuery : "yp_zpp.zpp_ore_umpire_result_cnt" //list cnt 가져오는 마이바티스 쿼리 아이디
			};
			...
			// EXEC_RFC : "FI"
			var param2 = {
				listQuery : "yp_zpp.zpp_ore_umpire_result_dt_list", //list가져오는 마이바티스 쿼리 아이디
				cntQuery : "yp_zpp.zpp_ore_umpire_result_dt_cnt" //list cnt 가져오는 마이바티스 쿼리 아이디
			};
