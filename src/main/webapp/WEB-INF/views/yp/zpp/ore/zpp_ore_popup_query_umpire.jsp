...
<body data-ng-app="app">
	...
	<div id="popup">
		...
		<div class="pop_content">
			...
			<div class="btn_wrap">
				<button class="btn btn_search" id="register_btn" type="">의뢰 대상 등록</button>
			</div>
	...
	<script>
		...
		setLotCountTable(lotCount)
		{
			...
			{
				var table = document.getElementById('table_' + String(Number(tableIdx)));
				...
				for(var i = 0;i < lotCount; i ++)
				{
					...
					AddColumn(table_row, '<td><input readonly onfocus="this.blur()" style="color:black; font-weight:bold; border:0px; background-color:transparent; width:55px;" id="' + cid + '"></td>');
					...
					var onclick_seller_str = 'onclick="input_click_seller(' + (idx).toString() + ', ' + (tableIdx).toString() + ');"';

					AddColumn(table_row, '<td><input readonly onfocus="this.blur()" style="color:black; font-weight:bold; border:0px; background-color:transparent; width:65px; type="text" id="edt_seller_action_' + (idx).toString() + '_' + String(tableIdx) + '" ' + onclick_seller_str + '></td>');

					var onclick_yp_str = 'onclick="input_click_yp(' + (idx).toString() + ', ' + (tableIdx).toString() + ');"';
		...
		function input_click_yp(idx1, idx2) {
			var obj_id = 'edt_yp_action_' + (idx1).toString() + '_' + (idx2).toString();

			if(l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] == 0) l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] = 1;
			else if(l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] == 1) l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] = 2;
			else l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] = 0;

			if(l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] == 0) set_NS(obj_id, "");
			else if(l_Umpire_Sel_YP[idx1 - 1][idx2 - 1] == 1) set_NS(obj_id, "UMPIRE");
			else set_NS(obj_id, "SPLIT");
		}

		function input_click_seller(idx1, idx2) {
			var obj_id = 'edt_seller_action_' + (idx1).toString() + '_' + (idx2).toString();

			if(l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] == 0) l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] = 1;
			else if(l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] == 1) l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] = 2;
			else l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] = 0;

			if(l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] == 0) set_NS(obj_id, "");
			else if(l_Umpire_Sel_SELLER[idx1 - 1][idx2 - 1] == 1) set_NS(obj_id, "UMPIRE");
			else set_NS(obj_id, "SPLIT");
		}
		...
		load_InitValue() {
			$.ajax({
				url : "/yp/zpp/ore/zpp_ore_get_umpire_decision",
				type : "POST",
			    cache:false,
			    async:true, 
				data : {
				...
				dataType : "json",
				success : function(result) {
					//	console.log("/yp/zpp/ore/zpp_ore_get_umpire_decision");
					...
					l_Umpire_Sel_SELLER[0][0] = result.SELLER_ACTION_1_1;
					l_Umpire_Sel_SELLER[1][0] = result.SELLER_ACTION_2_1;
					l_Umpire_Sel_SELLER[2][0] = result.SELLER_ACTION_3_1;
					l_Umpire_Sel_SELLER[3][0] = result.SELLER_ACTION_4_1;
					l_Umpire_Sel_SELLER[4][0] = result.SELLER_ACTION_5_1;
					l_Umpire_Sel_SELLER[5][0] = result.SELLER_ACTION_6_1;
					l_Umpire_Sel_SELLER[6][0] = result.SELLER_ACTION_7_1;
					l_Umpire_Sel_SELLER[7][0] = result.SELLER_ACTION_8_1;
					l_Umpire_Sel_SELLER[8][0] = result.SELLER_ACTION_9_1;
					l_Umpire_Sel_SELLER[9][0] = result.SELLER_ACTION_10_1;
					l_Umpire_Sel_SELLER[10][0] = result.SELLER_ACTION_11_1;
					l_Umpire_Sel_SELLER[11][0] = result.SELLER_ACTION_12_1;
					l_Umpire_Sel_SELLER[12][0] = result.SELLER_ACTION_13_1;
					l_Umpire_Sel_SELLER[13][0] = result.SELLER_ACTION_14_1;
					l_Umpire_Sel_SELLER[14][0] = result.SELLER_ACTION_15_1;
					l_Umpire_Sel_SELLER[15][0] = result.SELLER_ACTION_16_1;
					l_Umpire_Sel_SELLER[16][0] = result.SELLER_ACTION_17_1;
					l_Umpire_Sel_SELLER[17][0] = result.SELLER_ACTION_18_1;
					l_Umpire_Sel_SELLER[18][0] = result.SELLER_ACTION_19_1;
					l_Umpire_Sel_SELLER[19][0] = result.SELLER_ACTION_20_1;
					l_Umpire_Sel_SELLER[20][0] = result.SELLER_ACTION_21_1;
					l_Umpire_Sel_SELLER[21][0] = result.SELLER_ACTION_22_1;
					...
					l_Umpire_Sel_SELLER[0][1] = result.SELLER_ACTION_1_2;
					l_Umpire_Sel_SELLER[1][1] = result.SELLER_ACTION_2_2;
					l_Umpire_Sel_SELLER[2][1] = result.SELLER_ACTION_3_2;
					l_Umpire_Sel_SELLER[3][1] = result.SELLER_ACTION_4_2;
					l_Umpire_Sel_SELLER[4][1] = result.SELLER_ACTION_5_2;
					l_Umpire_Sel_SELLER[5][1] = result.SELLER_ACTION_6_2;
					l_Umpire_Sel_SELLER[6][1] = result.SELLER_ACTION_7_2;
					l_Umpire_Sel_SELLER[7][1] = result.SELLER_ACTION_8_2;
					l_Umpire_Sel_SELLER[8][1] = result.SELLER_ACTION_9_2;
					l_Umpire_Sel_SELLER[9][1] = result.SELLER_ACTION_10_2;
					l_Umpire_Sel_SELLER[10][1] = result.SELLER_ACTION_11_2;
					l_Umpire_Sel_SELLER[11][1] = result.SELLER_ACTION_12_2;
					l_Umpire_Sel_SELLER[12][1] = result.SELLER_ACTION_13_2;
					l_Umpire_Sel_SELLER[13][1] = result.SELLER_ACTION_14_2;
					l_Umpire_Sel_SELLER[14][1] = result.SELLER_ACTION_15_2;
					l_Umpire_Sel_SELLER[15][1] = result.SELLER_ACTION_16_2;
					l_Umpire_Sel_SELLER[16][1] = result.SELLER_ACTION_17_2;
					l_Umpire_Sel_SELLER[17][1] = result.SELLER_ACTION_18_2;
					l_Umpire_Sel_SELLER[18][1] = result.SELLER_ACTION_19_2;
					l_Umpire_Sel_SELLER[19][1] = result.SELLER_ACTION_20_2;
					l_Umpire_Sel_SELLER[20][1] = result.SELLER_ACTION_21_2;
					l_Umpire_Sel_SELLER[21][1] = result.SELLER_ACTION_22_2;
					...
					l_Umpire_Sel_SELLER[0][2] = result.SELLER_ACTION_1_3;
					l_Umpire_Sel_SELLER[1][2] = result.SELLER_ACTION_2_3;
					l_Umpire_Sel_SELLER[2][2] = result.SELLER_ACTION_3_3;
					l_Umpire_Sel_SELLER[3][2] = result.SELLER_ACTION_4_3;
					l_Umpire_Sel_SELLER[4][2] = result.SELLER_ACTION_5_3;
					l_Umpire_Sel_SELLER[5][2] = result.SELLER_ACTION_6_3;
					l_Umpire_Sel_SELLER[6][2] = result.SELLER_ACTION_7_3;
					l_Umpire_Sel_SELLER[7][2] = result.SELLER_ACTION_8_3;
					l_Umpire_Sel_SELLER[8][2] = result.SELLER_ACTION_9_3;
					l_Umpire_Sel_SELLER[9][2] = result.SELLER_ACTION_10_3;
					l_Umpire_Sel_SELLER[10][2] = result.SELLER_ACTION_11_3;
					l_Umpire_Sel_SELLER[11][2] = result.SELLER_ACTION_12_3;
					l_Umpire_Sel_SELLER[12][2] = result.SELLER_ACTION_13_3;
					l_Umpire_Sel_SELLER[13][2] = result.SELLER_ACTION_14_3;
					l_Umpire_Sel_SELLER[14][2] = result.SELLER_ACTION_15_3;
					l_Umpire_Sel_SELLER[15][2] = result.SELLER_ACTION_16_3;
					l_Umpire_Sel_SELLER[16][2] = result.SELLER_ACTION_17_3;
					l_Umpire_Sel_SELLER[17][2] = result.SELLER_ACTION_18_3;
					l_Umpire_Sel_SELLER[18][2] = result.SELLER_ACTION_19_3;
					l_Umpire_Sel_SELLER[19][2] = result.SELLER_ACTION_20_3;
					l_Umpire_Sel_SELLER[20][2] = result.SELLER_ACTION_21_3;
					l_Umpire_Sel_SELLER[21][2] = result.SELLER_ACTION_22_3;
					...
					l_Umpire_Sel_SELLER[0][3] = result.SELLER_ACTION_1_4;
					l_Umpire_Sel_SELLER[1][3] = result.SELLER_ACTION_2_4;
					l_Umpire_Sel_SELLER[2][3] = result.SELLER_ACTION_3_4;
					l_Umpire_Sel_SELLER[3][3] = result.SELLER_ACTION_4_4;
					l_Umpire_Sel_SELLER[4][3] = result.SELLER_ACTION_5_4;
					l_Umpire_Sel_SELLER[5][3] = result.SELLER_ACTION_6_4;
					l_Umpire_Sel_SELLER[6][3] = result.SELLER_ACTION_7_4;
					l_Umpire_Sel_SELLER[7][3] = result.SELLER_ACTION_8_4;
					l_Umpire_Sel_SELLER[8][3] = result.SELLER_ACTION_9_4;
					l_Umpire_Sel_SELLER[9][3] = result.SELLER_ACTION_10_4;
					l_Umpire_Sel_SELLER[10][3] = result.SELLER_ACTION_11_4;
					l_Umpire_Sel_SELLER[11][3] = result.SELLER_ACTION_12_4;
					l_Umpire_Sel_SELLER[12][3] = result.SELLER_ACTION_13_4;
					l_Umpire_Sel_SELLER[13][3] = result.SELLER_ACTION_14_4;
					l_Umpire_Sel_SELLER[14][3] = result.SELLER_ACTION_15_4;
					l_Umpire_Sel_SELLER[15][3] = result.SELLER_ACTION_16_4;
					l_Umpire_Sel_SELLER[16][3] = result.SELLER_ACTION_17_4;
					l_Umpire_Sel_SELLER[17][3] = result.SELLER_ACTION_18_4;
					l_Umpire_Sel_SELLER[18][3] = result.SELLER_ACTION_19_4;
					l_Umpire_Sel_SELLER[19][3] = result.SELLER_ACTION_20_4;
					l_Umpire_Sel_SELLER[20][3] = result.SELLER_ACTION_21_4;
					l_Umpire_Sel_SELLER[21][3] = result.SELLER_ACTION_22_4;
		...
		function set_Value() {
			for(var ac = 0;ac < l_INGREDIENT_CNT;ac ++)
			{
				for(var si = 0;si < l_LOT_COUNT;si ++) {
					...
					if(l_Umpire_Sel_SELLER[si][ac] == 0) set_NS(cn, "");
					else if(l_Umpire_Sel_SELLER[si][ac] == 1) set_NS(cn, "UMPIRE");
