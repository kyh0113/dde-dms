...
<body>
	...
	<div class="float_wrap" style="margin-bottom:5px;">
		<div class="fr">
			<div class="btn_wrap">
				<input type="button" class="btn_g" id="test_btn"  value="테스트"/>
			</div>
		</div>
	</div>
	<section class="section">
		<!-- 복붙영역(html) 시작, 복붙시 바꿔야할 값들 : id, data-ng-controller  -->
		<div id="test-uiGrid"  data-ng-controller="testListCtrl" style="height: 600px;">
	...
	app.controller('testListCtrl', ['$scope','$controller','$log','StudentService', 'uiGridConstants', 
...
$(document).ready(function(){
	...
	var scope = angular.element(document.getElementById("test-uiGrid")).scope(); //html id를 통해서 controller scope(this) 가져옴
	...
	var param = {
		listQuery : "yp_test.grid_ore_analysis_result_list", 				//list가져오는 마이바티스 쿼리 아이디
		cntQuery : "yp_test.grid_ore_analysis_result_list_cnt"						//list cnt 가져오는 마이바티스 쿼리 아이디
	}; 
