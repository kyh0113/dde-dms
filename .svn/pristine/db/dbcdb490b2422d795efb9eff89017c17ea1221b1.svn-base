...
<body>
	...
	<section class="section">
		...
		<div id="testRouteListCtrl-uiGrid"  data-ng-controller="testRouteListCtrl" style="height: 600px;">
	...
	app.controller('testRouteListCtrl', ['$scope','$controller','$log','StudentService', 'uiGridConstants', 
	function ($scope, $controller, $log, StudentService, uiGridConstants) {		//$scope(this)는 해당컨트롤러로 진입하기위한 접근지시자라고 보면됨
		...
		$scope.gridOptions = vm.gridOptions( 	// 그리드 옵션, 부모의 그리드 옵션에 파라미터를 던지면서 변경해서 대입
		{
			...
			paginationPageSizes : [ 20, 100, 200, 300, 400, 500, 1000 ], //한번에 보여질 로우수 셀렉트리스트	
...
$(document).ready(function(){
	...
	var scope = angular.element(document.getElementById("testRouteListCtrl-uiGrid")).scope(); //html id를 통해서 controller scope(this) 가져옴
