...
<body>
			...
			<div class="tbl_box">
				<table>
					...
					<tr>
						...
						<th>내역</th>
						<td>
							<input type="text" name="history" value="${req_data.srch_ent_code}">
						</td>
						<th>상태</th>
						<td>
							<!--  
							 ...
							 * D : 삭제
							-->
							<input id="state_all" type="radio" name="status" value="" checked="checked">
							<label for="state_all">전체</label>
							<input id="state_c" type="radio" name="status" value="C">
							<label for="state_c">생성</label>
							<input id="state_u" type="radio" name="status" value="U">
							<label for="state_u">수정</label>
							<input id="state_d" type="radio" name="status" value="D">
							<label for="state_d">삭제</label>
						</td>
			        </tr>
				</table>
				<div class="btn_wrap">
	...
	<section class="section">
		...
		<div id="fixture-uiGrid"  data-ng-controller="fixtureMasterHistListCtrl" style="height: 600px;">
	...
	app.controller('fixtureMasterHistListCtrl', ['$scope','$controller','$log','StudentService', 'uiGridConstants', 
...
$(document).ready(function(){
	...
	var param = {
		listQuery : "yp_fixture.grid_fixture_hist_list", 				//list가져오는 마이바티스 쿼리 아이디
		cntQuery : "yp_fixture.grid_fixture_hist_list_cnt"						//list cnt 가져오는 마이바티스 쿼리 아이디
	}; 
