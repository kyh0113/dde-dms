...
// 				var url = "http://gwdev.ypzinc.co.kr/ekp/eapp/app.do?cmd=appWrite&eappDoc.formId=EF164213678935652";	//개발	
...
// 		});
	...
	function fnRegValidation() {
		...
		if("" == $("input[name=WR_NAME]").val()){
			...
			swalWarningCB("완료예정일자를 입력해주세요.", function(){
	...
	<table class="tableTypeGray mb20">
		...
		<tbody>
			<tr>
				<th>제목</th>
				<td colspan="3">
					<input type="text" id="WR_NAME" name="WR_NAME" value="[자체처리]"/>
				</td>
			</tr>
			<tr>
				<th>작성부서</th>
		...
		<tbody>
			<tr>
				...
				<td>
					...
					~ 
					<input type="text" class="wid120 calendar dtp" name="WR_WEDATE" id="WR_WEDATE" value="" readonly/>
				</td>
				<th>완료예정일</th>
				<td>
					<input type="text" class="wid120 calendar dtp" name="WR_RE_DATE" id="WR_RE_DATE" value="" readonly/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					~ 
					<input type="text" class="wid120 calendar dtp" name="WR_TEDATE" id="WR_TEDATE" value="" readonly/>
				</td>
			</tr>
