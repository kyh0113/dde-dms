...
function WREntReg() {
		...
		if(fnRegValidation()){
			...
			$.ajax({
			    url: "/yp/wr/wr_reportinpop_insert",
			    type: "POST",
			    cache: false,
			    async: true,
			    dataType: "json",
...
<div id="popup">
	...
	<div class="pop_content">
		...
		<input type="hidden" name="WR_TYPE" id="WR_TYPE" value="E" />
		...
		<table width="100%" class="tbl-basic">
			...
			<tbody>
				<tr>
					...
					<td colspan="3">
						<input type="text" id="WR_NAME" name="WR_NAME" style="width:980px;" value="[자체처리]전산작업 보고서 "  placeholder="[자체처리]전산작업 보고서 "/>
					</td>
				</tr>
				<tr>
					<th>작성부서</th>
