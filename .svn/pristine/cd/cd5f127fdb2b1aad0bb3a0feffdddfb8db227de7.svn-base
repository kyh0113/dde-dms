...
<% 
	...
	//@PRD
	String confmKey = "U01TX0FVVEgyMDIxMDExMTE0MjMzMTExMDY1MDU="; // 검색API 승인키(영풍 운영용 검색키)
	
	//@DEV
	//String confmKey = "devU01TX0FVVEgyMDIxMDEwODEzMzMyODExMDY0Mzk="; // 검색API 승인키(localhost 개발용 검색키)
...
%>
<script type="text/javascript" src="/resources/yp/searchapi/js/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="/resources/yp/searchapi/js/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="/resources/yp/searchapi/css/addrlink.css"></link>
