...
<div class="input-group">
	<select class="form-control" id="fileList2" name="fileList2" style="width: auto; min-width:200px;">

	</select>
<span class="input-group-addon" style="padding:0px 0px;float : left; height:21px;"><button id="file_down2" class="white_btn_s" style="width:100%; height:100%;">파일다운</button></span>
</div>
<script>
$(document).ready(function(){
	$("#file_down2").on("click",function(){
		var attach_no = $("#fileList2 option:selected").data("attach");
		var ser_no = $("#fileList2 option:selected").data("ser");
