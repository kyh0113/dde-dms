 ...
 */
public class SelectListTag2 extends DefaultTagSupport {
	...
	public int doEndTag() throws JspException {
		try {
            ...
            SelectList2 showSelectList = new SelectList2(name, id,  script, values, names, selectedValue, defaultValue);
    		
			out.print(showSelectList.buildHtml());
		} catch (Exception e) {
			logger.error(e);
		}
		return (SKIP_BODY);
