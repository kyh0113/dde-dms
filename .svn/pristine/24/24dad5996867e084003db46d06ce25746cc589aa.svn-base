			...
			swal({
				...
				.then(function(result){
				  if(result){
						$.ajax({
							type: 'POST',
							url: '/yp/zhr/rez/updateResortReservControl',
							data: oFormArray,
							dataType: 'json',
							//async : false,
				...
				<section>
					<table width="100%" class="tbl-basic">
						...
						<tr>
							...
							<th>직 급</th>
							<td>
								<input type="text" name="emp_pos" size="1" style="width:165px;" value="${req_data.userPos}" readonly="readonly" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3" class="left">
1. 리조트 오픈 내용</br>
&nbsp;&nbsp;&nbsp;&nbsp;> 소노리조트 2023.12.1 ~ 2024.07.18 예약 가능</br>
</br>
2. 운영방법</br>
&nbsp;&nbsp;&nbsp;&nbsp;가. 년간 1인 2박 제한</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ 매년 3월 1일 이용가능 박 수 초기화</br>
&nbsp;&nbsp;&nbsp;&nbsp;나. 상반기 50박, 하반기 50박 선착순 예약</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ 주말,성수기예약 및 인기지점의 경우 빠르게 마감되오니 최소 1달 전 예약을 권합니다.</br>
&nbsp;&nbsp;&nbsp;&nbsp;다. 예약확정된 리조트의 이용을 취소할 경우 취소일 7일 전까지 담당자에게 안내 필수</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ 리조트 사전 입실확인 문자에서 "미입실" 회신하더라도 담당자에게 필히 연락바랍니다</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ 7일이내 취소시 리조트 1년간 이용 불가</br>
</br>
※ 예약문의 연락처</br>
&nbsp;&nbsp;&nbsp;&nbsp;- 인적자원관리팀 유하나사원 (근무시간 13:30 ~ 17:30)</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ 메일 혹은 메신저로 연락바랍니다.</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ ☎ : 010-7687-7701 / E-maill : kazya1207@ypzinc.co.kr</br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ㄴ 리조트 관련 문의는 소노리조트(1588-4888)에 연락바랍니다.</br>
							</td>
						</tr>
					</table>
				</section>
